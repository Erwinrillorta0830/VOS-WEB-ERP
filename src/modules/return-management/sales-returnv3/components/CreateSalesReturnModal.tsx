...
export function CreateSalesReturnModal({ isOpen, onClose, onSuccess }: Props) {
  ...
  const handleCreateReturn = async () => {
    ...
    // 🔴 NEW VALIDATION: Check for unselected Reason or Return Type
  ...
  const handleAddProducts = (newItems: any[]) => {
    ...
    const preparedItems = newItems.map((item) => {
      ...
      return {
        ...
        discountType: "",
        discountAmount: 0,
        // 🔴 UPDATED: Default to empty string to force user selection
        reason: "",
        returnType: "",
      };
    });
              ...
              <table className="w-full text-sm text-left min-w-[1100px]">
                <thead>
                  <tr className="bg-blue-600 text-white">
                    ...
                    <th className="px-4 py-3 font-semibold text-xs uppercase tracking-wider w-24 text-right">
                      Disc.
                    </th>
                    <th className="px-4 py-3 font-semibold text-xs uppercase tracking-wider w-32 text-right">
                      Total
                    </th>
                    <th className="px-4 py-3 font-semibold text-xs uppercase tracking-wider w-32">
                      Reason
                    </th>
                    <th className="px-4 py-3 font-semibold text-xs uppercase tracking-wider w-32">
                      Return Type
                      ...
                      >
                        ...
                        <td className="px-4 py-2">
                          <input
                            ...
                            min="0"
                            placeholder="0"
                            // 🔴 UPDATED: Made Read-Only and Visual Change
                            readOnly
                            className="w-full text-right border border-gray-200 bg-gray-100 rounded h-8 text-sm text-gray-500 cursor-not-allowed outline-none transition-all duration-200"
                            value={
                              item.discountAmount === 0
                                ? ""
                                : item.discountAmount
                        ...
                        <td className="px-4 py-2">
                          ...
                          <input
                            type="text"
                            className="w-full border border-gray-300 rounded h-8 text-xs px-2 bg-white focus:border-blue-500 outline-none transition-all duration-200 placeholder:text-gray-400"
                            value={item.reason}
                            onChange={(e) =>
                        ...
                        <td className="px-4 py-2">
                          ...
                          >
                            {/* 🔴 UPDATED: Added Default Placeholder */}
