...
export function SalesReturnHistory({
  ...
  return (
    <div className="flex flex-col space-y-6">
      {/* --- 1. SEARCH BAR --- */}
      <div className="bg-white p-1 rounded-xl border border-blue-100 shadow-sm">
      ...
      <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
        <div className="flex flex-col md:flex-row gap-4 items-end w-full">
          ...
          >
            ...
            <div
              className="h-10 w-full bg-slate-50 border border-slate-200 rounded-md flex items-center justify-between px-3 cursor-pointer hover:bg-slate-100 transition-colors"
            ...
            {/* Dropdown Content */}
            {isSalesmanOpen && (
              <div className="absolute top-[calc(100%+4px)] left-0 w-full z-50 bg-white border border-slate-200 rounded-md shadow-lg max-h-[300px] flex flex-col">
                <div className="p-2 border-b border-slate-100 sticky top-0 bg-white z-10">
                  <div className="relative">
                    <Search className="absolute left-2 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-slate-400" />
                    <input
                      className="w-full h-8 pl-8 pr-2 text-xs bg-slate-50 border border-slate-200 rounded-sm focus:outline-none focus:border-blue-500"
          ...
          <div className="w-full md:flex-1 space-y-1.5">
            ...
            >
              <SelectTrigger className="h-10 bg-slate-50 border-slate-200 text-slate-700 text-sm focus:ring-blue-500/20 w-full">
          ...
          <div className="w-full md:w-auto pb-0.5">
            <Button
              variant="ghost"
              onClick={handleReset}
              className="w-full md:w-auto h-9 px-4 text-blue-600 hover:text-blue-700 hover:bg-blue-50 font-medium text-sm transition-colors whitespace-nowrap"
            >
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex flex-col min-h-[500px]">
        <div className="flex-1 overflow-auto">
          <Table>
            <TableHeader className="bg-slate-50/50 sticky top-0 z-10 backdrop-blur-sm border-b border-slate-200">
              <TableRow className="hover:bg-transparent">
                <TableHead className="font-bold text-slate-700 pl-6 w-[140px] h-12">
                  Return No.
                </TableHead>
                <TableHead className="font-bold text-slate-700 min-w-[180px] h-12">
                  Salesman
                </TableHead>
                <TableHead className="font-bold text-slate-700 min-w-[220px] h-12">
                  Customer
                </TableHead>
                <TableHead className="font-bold text-slate-700 w-[120px] h-12">
                  Date
                </TableHead>
                <TableHead className="font-bold text-slate-700 text-right w-[120px] h-12">
                  Total Amount
                </TableHead>

                {/* 🟢 CENTERED STATUS HEADER */}
                <TableHead className="font-bold text-slate-700 text-center w-[120px] h-12">
                  Status
                </TableHead>

                <TableHead className="font-bold text-slate-700 min-w-[200px] h-12">
                  Remarks
                </TableHead>
              </TableRow>
            </TableHeader>
            ...
            <TableBody>
              {loading ? (
                ...
                data.map((row) => (
                  <TableRow
                    key={row.id}
                    className="group cursor-pointer hover:bg-slate-50/60 transition-colors border-b-slate-100 last:border-0"
                    onClick={() => onRowClick(row)}
                  >
                    <TableCell className="py-4 pl-6 font-semibold text-blue-600 group-hover:text-blue-700 transition-colors">
                      {row.returnNo}
                    </TableCell>
                    ...
                    <TableCell className="py-4 text-slate-400 text-xs italic">
                      <div
        ...
        {/* --- 4. PAGINATION --- */}
        <div className="p-4 border-t border-slate-100 bg-white flex flex-col sm:flex-row justify-between items-center gap-4 sticky bottom-0 z-20">
