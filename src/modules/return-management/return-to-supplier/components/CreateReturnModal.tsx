...
export function CreateReturnModal({ isOpen, onClose, onReturnCreated }: Props) {
  ...
  // ✅ REVISED: "Nuclear" Option - Uses !important to force width
  ...
  const getModalWidth = () => {
    ...
    // Default View: 1100px wide

    // The '!' specifically forces this style to override any defaults
      ...
      <Dialog open={isOpen} onOpenChange={(open) => !open && handleCloseFull()}>
        ...
        >
          ...
          {showProductPicker ? (
            ...
            <DialogHeader className="px-8 py-6 border-b flex flex-row items-center justify-between shrink-0 bg-white">
              <div>
              ...
              <div className="space-y-8">
                ...
                {step === "input" ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 bg-white p-6 rounded-xl border border-slate-200 shadow-sm relative z-20">
                    ...
                    <div
                      className="space-y-2.5 flex flex-col relative"
                      ref={supplierRef}
                    >
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            if (
                              ...
                              e.target.value !==
                                suppliers.find(
                                  (s) => s.supplier_name === selectedSupplierId,
                                )?.supplier_name
                            ) {
                              setSelectedSupplierId("");
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            if (
                              ...
                              e.target.value !==
                                branches.find(
                                  (b) => b.branch_name === selectedBranchId,
                                )?.branch_name
                            ) {
                              setSelectedBranchId("");
                            }
                    ...
                    {addedProducts.length > 0 ? (
                      ...
                      >
                        ...
                        <p className="text-xs text-slate-400 mt-1 font-medium">
                          Click to browse products or scan barcode
                        </p>
                      </div>
                    )}
                  </div>
            ...
            <DialogFooter className="px-8 py-5 border-t bg-white sm:justify-between gap-3 flex-shrink-0">
              ...
              <div>
                {step === "review" && (
                  <Button
                    ...
                    className="h-11 px-4 text-slate-500 hover:text-slate-900"
                  >
              ...
              <div className="flex gap-3">
                <Button
                  variant="outline"
                  onClick={handleCloseFull}
                  className="h-11 px-6 border-slate-200 text-slate-600 font-bold hover:bg-slate-50 hover:text-slate-900 rounded-xl"
                >
                  Cancel
                </Button>
                ...
                {step === "input" ? (
                  <Button
                    disabled={
                      !isSelectionComplete || addedProducts.length === 0
                    }
        ...
        <DialogContent className="sm:max-w-[400px] p-0 overflow-hidden border-none shadow-2xl bg-white rounded-xl">
          <div className="p-6 pt-8 text-center flex flex-col items-center">
            ...
            <p className="text-sm text-slate-500 mb-6 max-w-[280px] leading-relaxed font-medium">
              This will remove all {addedProducts.length} items from your
              selected list. This action cannot be undone.
            </p>
