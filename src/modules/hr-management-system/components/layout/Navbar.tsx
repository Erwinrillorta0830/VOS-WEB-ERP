        ...
        >
            <div className="flex items-center gap-4">
                ...
                <h1
                    ...
                    className="font-semibold text-lg transition-transform duration-300 cursor-pointer hover:text-indigo-700 dark:hover:text-indigo-300"
                >
            ...
            <div className="flex items-center gap-4">
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent className="mr-2">
                        {/* Optional: quick access back to /app from menu */}
